...
Подробнее: `.cursor/skills/svt-architecture/` (`reference.md` — архитектура, `roadmap.md` — дорожная карта MVP, `backlog.md` — чеклист работ), правило `svt-development-patterns`.
