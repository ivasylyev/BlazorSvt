...
[DetailSource("v2.vw_AverageRateLevel3_Detail", "AverageRateLevel3Id")]
public class AverageRateLevel3DetailDto
{
    ...
    public string? TransportRateCodes { get; set; }
    ...
    public decimal MinDailyTransportation { get; set; }
    public decimal MaxDailyTransportation { get; set; }
    ...
    public decimal PNPFromSize { get; set; }
