    ...
    : IDetailSettingsService<LocationsNodesDetailDto>
{
    public DetailSettingsCollection<LocationsNodesDetailDto> GetGridDetailSettings(string lang)
    {
        ...
        b.AddYesNo(group, x => x.Terminal, L["LocationsNodesDetailDto.Terminal"]);
        b.Add(group, x => x.OpenStreetMap, L["LocationsNodesDetailDto.OpenStreetMap"]);
        b.AddYesNo(group, x => x.Virtual, L["LocationsNodesDetailDto.Virtual"]);
        b.AddYesNo(group, x => x.IsFactory, L["LocationsNodesDetailDto.IsFactory"]);
        b.AddYesNo(group, x => x.IsPortShip, L["LocationsNodesDetailDto.IsPortShip"]);
        b.AddYesNo(group, x => x.IsPortStore, L["LocationsNodesDetailDto.IsPortStore"]);
        b.AddYesNo(group, x => x.IsStore, L["LocationsNodesDetailDto.IsStore"]);
