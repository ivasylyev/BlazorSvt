    ...
    : BaseGridSettingsService<ParityRatesDto>(localStorage, logger)
{
    ...
    protected override List<GridColumnSetting<ParityRatesDto>> GetDefaultSettings(string lang)
    {
        ...
        b.Add(x => x.TransportTypeCode, L["ParityRatesDto.TransportTypeCode"], visible: false, filterable: false);
        ...
        b.Add(x => x.TotalCostTransport, L["ParityRatesDto.TotalCostTransport"], filterable: false);
        b.Add(x => x.LoadOfTransport, L["ParityRatesDto.LoadOfTransport"], filterable: false);
        b.Add(x => x.TotalCostTon, L["ParityRatesDto.TotalCostTon"], filterable: false);
        ...
        b.Add(x => x.FactRate, L["ParityRatesDto.FactRate"], filterable: false);
        b.Add(x => x.BusinessPlanningRate, L["ParityRatesDto.BusinessPlanningRate"], filterable: false);
