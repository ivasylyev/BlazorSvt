...
- Жёсткое удаление — только для архивных/просроченных записей с согласованным для каждого справочника лагом (например, 2 года для ставок); перенос логики хранения и очистки из легаси SQL Agent в C# — по домену, вместе с CQRS конвейер записи (детали — roadmap.md §2 строка sync, backlog 0.1.7, 0.2.2.5, 0.7.2.9 / 0.8.2.3)
